...
\noin To learn different configurations of MOBI, refer to the primer by A. Schmittner (\url{https://github.com/tanio003/tmm/blob/TT_Release/Tutorial_MSI/MOBI2.0_Schmittner.pdf}). Also there are several key references for MOBI:
\begin{itemize}
...
\noin \textbf{In our exercise, we will try conducting a spin-up run for 3000 yrs using 30 prognostic tracers. Instructions will mostly follow that of S. Khatiwala.}
...
\section{Appendix}
\noin (Variables listed in MOBI \verb|control.in|):-> Eventually turn it into a Table

\begin{itemize}
\item \textbf{npzd}: (1) $k1n$ = half saturation constant for \ce{NO3 uptake} in [$\mu$M]?, (2) $capr$ = (3) $abio\verb|_|P$ = , (4) $alpha$ = , (5) $nup$ = quadratic mortality term of phytoplantkon in [-]?, (6) $nupt$ = linear mortality term of phytoplankton in [d-1] ?, 
(7) $redctn$ = Redfield C:N ratio [molar], (8) $geZ$ = ?, (9) Redfield \ce{-O2}:\ce{N} [molar], (10) $kfemin$ = ?, (11) $kfemax$ = ?, 
(12) $kfemin\verb|_|C$ = ?, (13) $kfemax\verb|_|C$ = ?, (14) $kfe\verb|_|D$ = ?, 
(15) $zprefC$ = ?, (16) $zprefP$ = ?, (17) $dissk0$ = ?, 
(18) $gbio$ = linear grazing rate [-]?, (19) $wd0$ = ?, (20) $nuz$ = quadratic mortality rate of zooplankton ?, (21) $jdiar$ = photosynthetic paramter?, (22) $nud0$ = ?, (23) $sgbdfac$ = ?, 
(24) $diazntp$ = ?, (25) $nup\verb|_|D$ = , (26) $abio\verb|_|C$ = ?, (27) $k1n\verb|_|C$ = ?, (28) $alpha\verb|_|C$ = ?, 
(29) $nuct0$ = ?, (30) $nupt0\verb|_|D$ = something with mortality, (31) $dfr$ = ?, (32) $dfrt$ = ?, (33) $dtnpzd$ = ?, 
(34) $hdop$ = ?, (35) $nudop0$ = ?, (36) $nudon0$ = ?, (37) $eps\verb|_|assim$ = ?, 
(38) $eps\verb|_|excr$ = something with excretion?, (39) $eps\verb|_|recy$ = something with remin?, (40) $eps\verb|_|wcdeni$ = something with water column denit?, (41) $eps\verb|_|bdeni$ something with benthic denit?, 
(42) $epx\verb|_|nfix$ = something with nfix?, (43) $mwz$ = ?, (44) mw = ?

\noin To find out what these mean, I may also need to refer to several papers \citep{Oschlies99, Giraud00, Schartau03, Schmittner05}. 
