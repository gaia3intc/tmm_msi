...
\noin - NPZD descriptions are from \url{https://github.com/OSU-CEOAS-Schmittner/UVicMOBI_fct_npzd_o2_n_fe_ca_caco3_c13_n15/blob/master/updates/npzd_src.F}

\begin{itemize}
\item \textbf{npzd}: Parameters related to biogeochemical NPZD model. 
{\footnotesize
\begin{longtable}{lllll} \hline
  Num  & Parameters         & Description                                                 & Unit                          & Def.      \\ \hline 
...
\noin To find out what these paramters actually do in the model, you may need to refer to several papers :
\begin{itemize}
