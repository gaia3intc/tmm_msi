function write_tracersavg28(netcdfFileName);
...
if usePFT  
  if useORGCARBON   
    ...
    tr12=readPetscBinVec('phycavg.petsc',-1);
    tr13=readPetscBinVec('zoocavg.petsc',-1);
    tr14=readPetscBinVec('phy2avg.petsc',-1);
    tr15=readPetscBinVec('phyc2avg.petsc',-1);
  else
    ['MOPS + PFT']
    tr10=readPetscBinVec('phy2avg.petsc',-1);
  end
else
  if useORGCARBON
